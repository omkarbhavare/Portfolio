...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <span className="font-medium !leading-[1.5] ">Transform your ideas into a stunning website.</span>{" "} <p className="text-[14px]"> Hi there! I'm a passionate software developer on a mission to bring your digital dreams to life with creative solutions and engaging user experiences. </p>
      </h1>
      </Fade>
